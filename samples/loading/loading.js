...
var cameraTransform =
    ...
    .push(cameraRotation)
    .push(new Cube.core.TranslationNode({z: 4.0}));
...
var transfoLight =
    ...
    .push(new Cube.core.TranslationNode({x: 3}));
transfoLight.update();
...
httpRequest.onreadystatechange = function() {
    if (httpRequest.readyState == 4) {
        if (httpRequest.status == 200) {
            ...
            scene.addObject(new Cube.core.Object({material: materialNodeEarth3, transformation: modelTransfoCommonBaseNode3, geometry: obj}));
        }
        else {
...
//httpRequest.open("GET", "../sandbox/suzanne.json", true); // Doesn't work with POST
httpRequest.open("GET", "../sandbox/icosphere.json", true); // Doesn't work with POST
httpRequest.send();
